...
Route::get('pages/project-info', [FrontViewController::class, 'projectInfo'])->name('page.project-info');
Route::get('pages/project-details', [FrontViewController::class, 'projectDetails'])->name('page.project-details');
...
//______________ DOWNLOAD
Route::get('pages/download-profile', [FrontViewController::class, 'downloadProfile'])->name('page.download-profile');
Route::get('pages/download-product', [FrontViewController::class, 'downloadProduct'])->name('page.download-product');
...
Route::get('pages/gallery-video',[FrontViewController::class,'galleryVideo'])->name('page.gallery-video');
//______________ BLOG
...
//______________ CAREER
Route::get('pages/career', [FrontViewController::class, 'career'])->name('page.career');
